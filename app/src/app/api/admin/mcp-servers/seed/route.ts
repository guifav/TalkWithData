...
const MCP_MCPS = [
  {
    name: "Analytics",
    description:
      "82 analytics views covering Sales, CS, Marketing, Presales, Alerts, Forms, Company, Farmer, and Monitor domains. RevOps dashboards, pipeline, NRR, churn risk, funnel metrics.",
    endpoint: "https://mcp.example.com/api/mcp/analytics",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/marketing",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/cx",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/matchmaking",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/journey-explorer",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/full",
  ...
  },
  {
    ...
    endpoint: "https://mcp.example.com/api/mcp/clusters",
    requiredScope: "bq:read",
  },
  {
    name: "Data Catalog",
    description:
      "Taxonomy-oriented surface across events, sessions, Signals signals, and contact interests — all organised by the 10 canonical internal dimensions. Events by taxonomy, session-level classification, Signals signal coverage, contact interest discovery.",
    endpoint: "https://mcp.example.com/api/mcp/catalog",
 ...
 * Seed the registry with known Analytics MCPs (superadmin).
