...
export const PAGE_SUBTITLE: I18n = {
  pt: "Tudo o que você precisa saber para usar o internal Dashboards.",
  en: "Everything you need to know to use internal Dashboards.",
  es: "Todo lo que necesitas saber para usar internal Dashboards.",
};
...
export const GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    content: {
      pt: `O internal Dashboards é a plataforma interna do the project para criar, visualizar e compartilhar dashboards e relatórios interativos.

• **Acesso:** Entre com seu e-mail corporativo do internal (@example.com) via login do Google.
• **Quem pode usar:** Todos os colaboradores do the project com conta autorizada.
...
**Dica:** Marque seus dashboards favoritos com a ⭐ para encontrá-los rapidamente na aba **Favoritos**.`,
      en: `internal Dashboards is the the project's internal platform for creating, viewing, and sharing interactive dashboards and reports.

• **Access:** Sign in with your internal corporate email (@example.com) via Google login.
• **Who can use it:** All the project team members with an authorized account.
...
**Tip:** Star ⭐ your favorite dashboards so you can find them quickly in the **Favorites** tab.`,
      es: `internal Dashboards es la plataforma interna del the project para crear, visualizar y compartir dashboards y reportes interactivos.

• **Acceso:** Inicia sesión con tu correo corporativo de internal (@example.com) vía Google.
• **Quién puede usarlo:** Todos los colaboradores del the project con cuenta autorizada.
...
**Consejo:** Marca tus dashboards favoritos con ⭐ para encontrarlos rápidamente en la pestaña **Favoritos**.`,
    },
  },
  {
    id: "home",
...
• **Favoritos:** Dashboards marcados com ⭐ aparecem na aba **Favoritos**, junto das demais listas principais.
...
• **Favoritos:** Los dashboards marcados con ⭐ aparecen en la pestaña **Favoritos**, junto con las otras listas principales.
...
**Consejo:** Usa nombres descriptivos — ayuda a todos a encontrar tu dashboard después.`,
  ...
  },
  {
    ...
    content: {
      pt: `O recurso Conversar com Dados permite fazer perguntas em linguagem natural sobre os dados do internal — e a IA responde com análises, tabelas e gráficos.
...
**Dica:** Seja específico nas perguntas. "Quantos membros novos entraram em março?" funciona melhor que "me fale sobre membros".`,
      en: `The Chat with Data feature lets you ask questions in natural language about internal data — and the AI responds with analyses, tables, and charts.
...
**Tip:** Be specific in your questions. "How many new members joined in March?" works better than "tell me about members".`,
      es: `La función Conversar con Datos permite hacer preguntas en lenguaje natural sobre los datos de internal — y la IA responde con análisis, tablas y gráficos.
...
• **⚠️ Pré-requisito:** Requer acesso MCP — você precisa ter pelo menos uma fonte de dados atribuída ao seu perfil. Sem isso, a opção não aparece. Solicite ao administrador.
...
• **⚠️ Prerequisite:** Requires MCP access — you need at least one data source assigned to your profile. Without it, the option won't appear. Request it from your admin.
...
• **⚠️ Prerrequisito:** Requiere acceso MCP — necesitas al menos una fuente de datos asignada a tu perfil. Sin eso, la opción no aparece. Solicítalo a tu administrador.
...
• **Definir campos:** Na página de visualização, clique no ícone de ⚙️ (engrenagem) para abrir o construtor de esquema. Defina os campos que o dashboard precisa.
...
• **Define fields:** On the view page, click the ⚙️ (gear) icon to open the schema builder. Define the fields the dashboard needs.
...
• **Definir campos:** En la página de visualización, haz clic en el ícono de ⚙️ (engranaje) para abrir el constructor de esquema. Define los campos que el dashboard necesita.
...
• **Criar pasta:** Na página inicial, clique no botão de gerenciar pastas (⚙️) ao lado dos filtros de pasta.
• **Adicionar à pasta:** No menu ⋮ de qualquer dashboard, selecione **Adicionar à pasta**.
• **Favoritos:** Clique na ⭐ no canto de qualquer dashboard para marcá-lo como favorito. Favoritos aparecem na aba **Favoritos** da home.
...
• **Create a folder:** On the home page, click the folder management button (⚙️) next to the folder filters.
• **Add to folder:** In any dashboard's ⋮ menu, select **Add to folder**.
• **Favorites:** Click the ⭐ on any dashboard's corner to mark it as a favorite. Favorites appear in the **Favorites** tab on the home page.
...
• **Crear carpeta:** En la página principal, haz clic en el botón de gestión de carpetas (⚙️) al lado de los filtros.
• **Agregar a carpeta:** En el menú ⋮ de cualquier dashboard, selecciona **Adicionar à pasta**.
• **Favoritos:** Haz clic en la ⭐ en la esquina de cualquier dashboard para marcarlo como favorito. Los favoritos aparecen en la pestaña **Favoritos** de la home.
...
• **⚠️ Multi-página:** A restauração de versões não está disponível para dashboards ZIP (multi-página). Para esses, faça upload de um novo ZIP.
...
• **⚠️ Multi-page:** Version restore is not available for ZIP (multi-page) dashboards. For those, upload a new ZIP.
...
• **⚠️ Multi-página:** La restauración de versiones no está disponible para dashboards ZIP (multi-página). Para esos, sube un nuevo ZIP.
...
• **Como acessar:** Clique no ícone 🛡️ **Admin** no cabeçalho (visível apenas para admins).
...
• **How to access:** Click the 🛡️ **Admin** icon in the header (visible only to admins).
...
• **Cómo acceder:** Haz clic en el ícono 🛡️ **Admin** en el encabezado (visible solo para admins).
