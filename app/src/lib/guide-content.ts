...
•**Favoritos:**Dashboards marcados como favoritos aparecem na aba**Favoritos**.
...
•**Favoritos:**Dashboards marcados como favoritos aparecem na aba**Favoritos**, junto das demais listas principais.
...
•**Fluxo:**Descreva o dashboard que precisa, depois a IA consulta os dados via MCP, depois gera um dashboard HTML interativo, depois você pode refinar com instruções adicionais.
...
•**Flow:**Describe the dashboard you need, depois the AI queries data via MCP, depois generates an interactive HTML dashboard, depois you can refine with additional instructions.
...
•**Flujo:**Describe el dashboard que necesitas, depois la IA consulta datos vía MCP, depois genera un dashboard HTML interactivo, depois puedes refinar con instrucciones adicionales.
...
•**Link de Embed:**Qualquer usuário com acesso ao dashboard pode gerar um link de embed temporário (válido por 7 dias) pelo menu ⋮ then**Copiar link de embed**.
...
•**Embed link:**Any user with access to the dashboard can generate a temporary embed link (valid for 7 days) via ⋮ menu then**Copy embed link**.
...
•**Link de Embed:**Cualquier usuario con acceso al dashboard puede generar un link de embed temporal (válido por 7 días) vía menú ⋮ then**Copiar link de embed**.
