...
export const PROMPT_GOVERNANCE: Record<PromptKey, PromptGovernance> = {
  "builder.platform_rules": {
    ...
    composition: [
      ...
      "Vem antes de freshness, dinamismo, playbook GRI, fontes MCP e database.",
    ],
  ...
  "builder.gri_playbook": {
    purpose:
      "Fornece contexto institucional, identidade visual e padroes minimos de dashboards para o GRI Institute.",
    consumers: ["Builder"],
    sourceFiles: [
      "app/src/lib/ai-prompt.ts",
      "app/src/app/api/ai/chat/route.ts",
