...
All screenshots use synthetic data generated by the isolated local E2E stack.

![Talk With Data home showing neutral demonstration dashboards](docs/screenshots/home-dashboards.png)

<table>
  <tr>
    <td width="50%"><strong>Dashboard view</strong><br><img src="docs/screenshots/dashboard-view.png" alt="Revenue Pulse dashboard inside the authenticated dashboard view" width="100%"></td>
    <td width="50%"><strong>AI data chat</strong><br><img src="docs/screenshots/ai-data-chat.png" alt="AI data chat answering a question with a governed dataset tool" width="100%"></td>
  </tr>
  <tr>
    <td width="50%"><strong>Governed data sources</strong><br><img src="docs/screenshots/data-sources-admin.png" alt="Admin screen for governed CSV data sources" width="100%"></td>
    <td width="50%"><strong>Embed view</strong><br><img src="docs/screenshots/embed-view.png" alt="Token-based dashboard embed without the application shell" width="100%"></td>
  </tr>
</table>
...
`npm run capture:readme-screenshots` uses the same isolated services and
regenerates the neutral images under `docs/screenshots/`. It does not connect to
production Firebase, GCP, or PostgreSQL resources.
